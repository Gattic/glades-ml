...
| 10 | **MPOT — Matrix Product Operator weight decomposition (DESIGN SHIPPED)** | weight memory (+ forward speed) | projected **65–500× weight compression** at bond D=16 (nested in Stiefel); 2.8× forward GEMM speedup | design brief in `research/PARADIGM_SHIFT_10_DESIGN.md` (304 lines); 3-week prototype plan; implementation begins next iteration |
