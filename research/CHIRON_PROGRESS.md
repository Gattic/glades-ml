...
| 19 | **IBGRAD — Information-Bottleneck Gradient Subspace (SELECTED, Phase 1 next)** | gradient subspace rank (Adam state + backward compute) | **20× Adam state + 20× backward GEMM** at r=0.05·N per block; composes multiplicatively with OVFG/MFIO/DFA/GFIB; **compound TRCD × LCP × IBGRAD = 282× theoretical** (56× realistic at 20% realization) | design `PARADIGM_SHIFT_19_{SELECTION,CANDIDATE_A/B/C}.md`; P\* = top-r eigenvectors of E[g gᵀ] (variational PCA on gradient stream); PRX deferred #20, PFE deferred #21 |
